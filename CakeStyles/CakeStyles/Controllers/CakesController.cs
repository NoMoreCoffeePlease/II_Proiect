...
namespace CakeStyles.Controllers
{
    public class CakesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,Description,Price")] Cake cake)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,Description,Price")] Cake cake)
        {
            if (id != cake.Id)
            {
                return NotFound();
