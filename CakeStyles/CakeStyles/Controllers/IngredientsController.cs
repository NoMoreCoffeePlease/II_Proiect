...
namespace CakeStyles.Controllers
{
    public class IngredientsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IngredientsUsed,Calories")] Ingredients ingredients)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,IngredientsUsed,Calories")] Ingredients ingredients)
        {
